...
// Placeholder until a ContactContent model/controller/route exists — build
...
const AdminContactContent = () => {
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col items-center px-4 py-20 text-center">
      <span className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#8B5CF6]/10 text-2xl text-[#8B5CF6]">
        <i className="fa-solid fa-envelope"></i>
      </span>
      <h1 className="vd-display text-xl font-extrabold text-[#1F2937]">Contact Page Editor — Coming Soon</h1>
      <p className="vd-body mt-2 max-w-md text-sm text-[#6B7280]">
        This section isn't wired up to the backend yet. Once it is, you'll be able to edit contact details, address
        and the form heading from here.
      </p>
      <button
